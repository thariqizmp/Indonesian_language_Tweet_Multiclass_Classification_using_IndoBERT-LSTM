...
Original file is located at
    https://colab.research.google.com/drive/1Ta5sFEcsPRRHawL47lZJ_SJjQqxxGi9m
...
callbacks_list = [EarlyStopping(monitor='val_accuracy',
                                ...
                                mode='max',
                                verbose=1),
                  ModelCheckpoint(checkpoint_path+"128_checkpoint_indobert_lstm_leaked_word_deleted",
